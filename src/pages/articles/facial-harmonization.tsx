...
export function FacialHarmonizationArticlePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative pt-24 md:pt-32 pb-12 md:pb-24 bg-gradient-to-b from-[#fff5f8] to-white overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold text-[#6f0d44] mb-6">
                Harmonização Facial
              </h1>
