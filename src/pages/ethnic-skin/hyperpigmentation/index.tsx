      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="absolute inset-0 w-full h-full">
          <div className="relative w-full h-full">
            <img
              ...
              alt="Tratamento de Hiperpigmentação em Pele Negra"
        ...
        <div className="relative container mx-auto px-4 pt-20">
          <div className="max-w-3xl">
            ...
            >
              Tratamento especializado para hiperpigmentação em peles negras, com foco na uniformização segura do tom da pele.
            </motion.p>
            ...
            >
              ...
              <div className="prose prose-lg">
                <p className="text-gray-600 leading-relaxed">
                  O tratamento de hiperpigmentação em peles negras requer uma abordagem especializada e cuidadosa. Nossa clínica oferece protocolos personalizados que combinam diferentes tecnologias e ativos para tratar manchas e descolorações de forma segura e eficaz.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Utilizamos produtos e técnicas específicos para peles melanodérmicas, garantindo resultados visíveis sem comprometer a saúde e a beleza natural da pele.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-16">
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#6f0d44] mb-4">Manchas Pós-Inflamatórias</h3>
                  <p className="text-gray-600">
                    Tratamento para manchas que surgem após inflamações ou lesões na pele.
                  </p>
                </div>
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#6f0d44] mb-4">Manchas Solares</h3>
                  <p className="text-gray-600">
                    Tratamento para manchas causadas pela exposição solar excessiva.
                  </p>
                </div>
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#6f0d44] mb-4">Hiperpigmentação Hormonal</h3>
                  <p className="text-gray-600">
                    Tratamento para manchas relacionadas a alterações hormonais.
                  </p>
                </div>
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#6f0d44] mb-4">Manchas de Acne</h3>
                  <p className="text-gray-600">
                    Tratamento para manchas residuais após lesões de acne.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-16">
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    Análise do tipo e causa da hiperpigmentação para definir o melhor tratamento.
                  </p>
                </div>
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg">
                ...
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg">
                  ...
                  <p className="text-gray-600">
                    Prescrição de produtos específicos para uso domiciliar.
                  </p>
                </div>
                <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-[#6f0d44] mb-4">Manutenção</h3>
                  <p className="text-gray-600">
                    Acompanhamento e cuidados para manter os resultados.
                  </p>
                </div>
              </div>
