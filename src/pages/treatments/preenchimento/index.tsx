      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="relative container mx-auto px-4 pt-20">
          <div className="max-w-3xl">
            ...
            >
              Restaure volume e suavize linhas de expressão com ácido hialurônico de última geração.
            </motion.p>
            ...
            >
              ...
              <div className="prose prose-lg">
                <p className="text-gray-600 leading-relaxed">
                  O preenchimento facial com ácido hialurônico é um procedimento minimamente invasivo que visa restaurar o volume perdido e suavizar linhas de expressão. Utilizamos produtos de última geração, seguros e com resultados naturais.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  O tratamento é personalizado para cada paciente, considerando suas características faciais e objetivos estéticos, garantindo resultados harmoniosos e naturais.
                </p>
              </div>
